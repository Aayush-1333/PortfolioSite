...
export default function Projects() {
    return (
        <div className='bg-gradient-to-br from-blue-700 to-green-400'>
            <div className='flex-col p-4 space-y-6'>
                <h1 className='text-3xl text-white underline'>My Projects</h1>
                <br />

                <div className='bg-white rounded-lg p-4 mx-auto w-[1500px] text-left'>
                    ...
                    <p className='mt-2 text-left'>You can check out my project using this github link ---
